...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-custom">Restaurant Information System</a>
        </div>
            ...
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu">
					...
					<?php } if($_SESSION['login'] == 1) {?>
						...
						<li><a href="#">Restaurant Management</a>
							<ul>
					...
					<?php } else { ?>
						<li><a href="./restaurant-listing.php">All Restaurant</a></li>
